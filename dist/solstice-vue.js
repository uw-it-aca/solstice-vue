...
const Qo = /* @__PURE__ */ U(Ka, [["render", Qa]]), Ya = {
  props: {
    tabsId: {
      // must match tab panelId
      type: [String, Number],
...
const Yo = /* @__PURE__ */ U(Ya, [["render", Va]]), Ha = {
  props: {
    variant: {
      type: String,
      required: !1,
...
const jo = /* @__PURE__ */ U(Ha, [["render", qa]]), Xa = {
  props: {
    panelId: {
      // must match tab panelId
      type: [String, Number],
...
const Vo = /* @__PURE__ */ U(Xa, [["render", _a]]), $a = {
  inject: ["mq"],
  props: {
    appName: {
      type: String,
...
const Ho = /* @__PURE__ */ U($a, [["render", ge]]), de = {
  inject: ["mq"],
  props: {
    appName: {
      type: String,
      ...
      o("div", Pe, [
        o("div", Fe, [
          o("div", Ge, [
            ...
            o("div", xe, [
              n.appDeptName ? (l(), t("div", Ke, L(n.appDeptName), 1)) : y("", !0),
              o("a", {
                href: n.appRootUrl,
        ...
        a.$slots.footer ? f(a.$slots, "footer", { key: 0 }, () => [
          o("div", an, [
            o("div", en, [
              ...
              o("div", ln, " Copyright © " + L((/* @__PURE__ */ new Date()).getFullYear()) + "University of Washington ", 1)
            ])
          ])
        ]) : y("", !0)
      ])
...
const zo = /* @__PURE__ */ U(De, [["render", un]]), gn = {
  props: {
    variant: {
      type: String,
      default: "standard"
  ...
  return n.variant === "flyout" ? (l(), t("div", dn, [
    o("div", sn, [
      n.userOverride ? (l(), t("a", fn, [
        o("span", mn, L(n.userNetid), 1),
        e[0] || (e[0] = o("i", { class: "bi bi-arrow-right text-danger me-1" }, null, -1)),
        o("span", yn, L(n.userOverride), 1)
      ])) : (l(), t("a", Cn, L(n.userNetid), 1)),
      o("div", Nn, [
        ...
        o("p", En, L(n.userOfficialName) + ", " + L(n.userPreferredName) + ", " + L(n.userPronouns), 1),
        o("p", pn, [
...
const qo = /* @__PURE__ */ U(gn, [["render", In]]);
function kn(a, e) {
...
const Dn = Object.prototype.toString, Rn = (a) => Dn.call(a) === "[object Object]", Pn = () => {
};
function Aa(...a) {
  if (a.length !== 1) return Ua(...a);
  const e = a[0];
  return typeof e == "function" ? Ca(Da(() => ({
    get: e,
    set: Pn
  }))) : Na(e);
}
...
function Wn(a, e, n = {}) {
  const { eventFilter: r, initialState: c = "active", ...i } = n, { eventFilter: g, pause: d, resume: m, isActive: u } = Gn(r, { initialState: c });
  return {
    stop: Kn(a, e, {
      ...i,
      eventFilter: g
...
function Jn(a, e = {}) {
  const { window: n = K, ssrWidth: r = /* @__PURE__ */ Hn() } = e, c = /* @__PURE__ */ jn(() => n && "matchMedia" in n && typeof n.matchMedia == "function"), i = H(typeof r == "number"), g = H(), d = H(!1), m = (u) => {
    d.value = u.matches;
  };
  return Fa(() => {
    if (i.value) {
...
function $n(a, e, n, r = {}) {
  ...
  if (!n) return S;
  const T = R(e), j = Zn(T), P = (c = r.serializer) !== null && c !== void 0 ? c : _n[j], { pause: I, resume: D } = On(S, (s) => F(s), {
    flush: i,
    deep: g,
    eventFilter: B
  });
  ...
  C && d && (n instanceof Storage ? ra(C, "storage", Q, { passive: !0 }) : ra(C, ua, V)), A ? ba(() => {
    O = !0, k();
  }) : k();
  function Y(s, v) {
    if (C) {
...
function eo(a = {}) {
  const { selector: e = "html", attribute: n = "class", initialValue: r = "auto", window: c = K, storage: i, storageKey: g = "vueuse-color-scheme", listenToStorageChanges: d = !0, storageRef: m, emitAuto: u, disableTransition: N = !0 } = a, C = {
    auto: "",
    light: "light",
    dark: "dark",
    ...a.modes || {}
  ...
  })), S = W(() => A.value === "auto" ? E.value : A.value), b = va("updateHTMLAttrs", (I, D, O) => {
...
const Xo = /* @__PURE__ */ U(no, [["render", go]]);
function so(a) {
...
function Co() {
  ...
  function d(u = {
    ...
    value: "{countryCode}"
  }, { sortBy: N, sortDataBy: C, filter: B } = {}) {
    const E = [];
    let A = r.default;
    if (typeof B == "function" && (A = A.filter(B)), C) {
      const S = new Intl.Collator([], { sensitivity: "accent" });
      A.sort((b, T) => S.compare(b[C], T[C]));
    }
    if (A.forEach((S) => {
      const b = {};
      for (const T in u)
  ...
  function m(u = "countryCode", N = "{countryNameEn} ({countryCode})", { filter: C } = {}) {
    const B = {};
    let E = r.default;
    return typeof C == "function" && (E = E.filter(C)), E.forEach((A) => {
      const S = (0, n.default)(N, A);
      B[String(A[u])] = S;
    }), B;
  }
...
function bo(a, e, n, r, c, i) {
  return l(), t(ta, null, [
    o("button", Eo, [
      o("span", po, L(i.flag(c.selectedCountry.code)), 1)
    ]),
    o("ul", ho, [
      o("li", null, [
        o("button", {
...
const Zo = /* @__PURE__ */ U(Lo, [["render", bo]]), wa = "data:image/png;base64,", To = {
  ...
  methods: {
    clearUserOverride: function() {
      return console.log("Clearing override from SUSer component..."), fetch(this.clearOverrideUrl, {
        method: "POST",
        headers: {
        ...
        console.error("Error clearing override:", a);
      }).finally(() => {
...
}, Do = { class: "p-3" }, Ro = { class: "d-flex justify-content-center" }, Po = ["src"], Fo = {
  key: 1,
  src: wa,
  class: "img-profile rounded-circle",
  alt: "user avatar"
}, Go = { class: "mt-3" }, xo = { class: "mt-3 pt-3 border-top" }, Ko = ["href"];
  ...
  return l(), t("div", {
    ...
    o("div", vo, [
      o("a", {
        ...
        e[1] || (e[1] = o("i", { class: "bi bi-chevron-down me-1" }, null, -1))
      ], 2),
      o("div", Mo, [
        n.userOverride ? (l(), t("div", Uo, " You are overriding as another user ")) : y("", !0),
        o("div", Do, [
          o("div", Ro, [
            n.photoUrl ? (l(), t("img", {
              key: 0,
          ...
          o("div", xo, [
            n.userOverride ? (l(), t("a", {
              ...
              onClick: e[0] || (e[0] = (g) => i.clearUserOverride())
            }, [...e[3] || (e[3] = [
...
const _o = /* @__PURE__ */ U(To, [["render", Wo], ["__scopeId", "data-v-b6ea5b1d"]]);
export {
  Xo as SColorMode,
  Zo as SCountryCode,
  qo as SProfile,
